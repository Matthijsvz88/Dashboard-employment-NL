...
nav = dbc.Nav(
    [html.Img(src="assets/logopic.png", id = 'logo-image'),
        dbc.NavLink(["Dashboard Werkgelegenheid",html.Br(), "Nederland 2022"], class_name = 'link', href="/"),
        dbc.NavLink(["Analyse Werkgelegenheid",html.Br(), "Nederland"], class_name = 'link', href="/analyse"),
        dbc.NavLink(["Check Project",html.Br(),"on GitHub"],target = "_blank",class_name = 'link', href=linkgithub)
    ], id = 'navbar'
)

layout = html.Div(
    [nav, dash.page_container # dash.page_container contains the page data you find in pages file
     ])
